        ...
        <div class="container-fluid" id="container-wrapper">
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <div class="btn-group">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModal-<?php echo $row["nim"]; ?>">
                                  <i class="fa fa-wrench mr-2"></i>Edit
                                </button>
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModal-<?php echo $row["nim"]; ?>">
                          ...
                          <!-- Modal Edit-->
                          <div class="modal fade" id="editModal-<?php echo $row["nim"]; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <form action="proses_crud.php" method="POST">
                                    ...
                                    <input type="hidden" name="action" value="updateStudents">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" value="<?php echo $row["nama"]; ?>" required>   
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="gender">Gender</label>
                                        <input type="text" name="gender" class="form-control" id="gender" value="<?php echo $row["jenis_kelamin"]; ?>" required>   
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="birthplace">Birthplace</label>
                                        <input type="text" name="birthplace" class="form-control" id="birthplace" value="<?php echo $row["ttl"]; ?>" required>   
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="address">Address</label>
                                        <input type="text" name="address" class="form-control" id="address" value="<?php echo $row["alamat"]; ?>" required>   
                                    </div>
                            ...
                            <div class="modal fade" id="deleteModal-<?php echo $row["nim"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabelLogout"
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p>Are you sure you want to delete data <?php echo $row["nama"]; ?> ?</p>
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-outline-primary" data-dismiss="modal">Cancel</button>
                                    <a href="proses_crud.php?nim=<?php echo $row["nim"]; ?>&action=deleteStudents" class="btn btn-danger">Delete</a>
                                  </div>
                                </div>
                              </div>
                            </div>
          ...
          <div class="modal fade" id="createModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Create New Data Students</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form action="proses_crud.php" method="POST">
                    ...
                    <div class="form-group mb-2">
                        <label for="name">Name</label>
                        <input type="text" name="name" class="form-control" id="name" required placeholder="Cth : Alex Aurafo">   
                    </div>
                    <div class="form-group mb-2">
                        <label for="gender">Gender</label>
                        <input type="text" name="gender" class="form-control" id="gender" required placeholder="Cth : Pria/Wanita">   
                    </div>
                    <div class="form-group mb-2">
                        <label for="birthplace">Birthplace</label>
                        <input type="text" name="birthplace" class="form-control" id="birthplace" required placeholder="Cth : Jakarta, 18 November 2000">   
                    </div>
                    <div class="form-group mb-2">
                        <label for="address">Address</label>
                        <input type="text" name="address" class="form-control" id="address" required placeholder="Cth : Tangerang Selatan, No 44 RT 8 RW 9, Tangerang">   
                    </div>

...
<body>
    ...
    <section class="header-form">
        ...
        <div class="banner-home">
            <h1>Login Account Students 2023</h1>
    ...
    <!-- resource from https://www.w3schools.com/php/php_form_validation.asp and then https://tryphp.w3schools.com/showphp.php?filename=demo_form_validation_escapechar, For Integrate DB : https://www.geeksforgeeks.org/how-to-insert-form-data-into-database-using-php/ and https://www.w3schools.com/php/php_mysql_select.asp-->
    <?php 
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            $sql = "SELECT id, name, email FROM account_mhs WHERE email = '$email'";
            $result = $conn->query($sql);

            if ($result->num_rows > 0) {
            // output data of each row
            while($row = $result->fetch_assoc()) {
                echo "Your Login Successfully with " .
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        ...
        <label>Don't have an account ? 
            <a href="registration_students.php">Sign Up here</a>
        </label>
    </form>

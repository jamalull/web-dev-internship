...
<body>
    ...
    <!-- resource from https://www.w3schools.com/php/php_form_validation.asp and then https://tryphp.w3schools.com/showphp.php?filename=demo_form_validation_escapechar -->
    <?php 
    ...
    function uploaded_file(){
        if(isset($_POST['submit'])){ 
            ...
            $filepath = "C:/xampp/htdocs/web-campus-profile/assets/img/uploads/" . $_FILES["photo"]["name"];
            
            if(move_uploaded_file($_FILES["photo"]["tmp_name"], $filepath)) {
                echo "<img src='assets/img/uploads/$namaFile' alt='$namaFile' width='150px' height='150px'>";
            } 
            else {
                echo "Error !!";
            }
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group phonecall">
            ...
            <input name="phone" required type="number" id="phonecall" placeholder="Enter your phone call">
        </div>
